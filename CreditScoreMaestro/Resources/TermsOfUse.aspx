<%@ Page Title="Terms Of Use" Language="C#" MasterPageFile="~/MasterPages/UserX.master" AutoEventWireup="true" CodeFile="TermsOfUse.aspx.cs" Inherits="Resources_TermsOfUse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<meta name="description" content="The Creditscoremaestro terms of use policy."/>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ColumnTwoRowOne" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cpMainContent" Runat="Server">
<br />
<div class="container terms mt-5">
