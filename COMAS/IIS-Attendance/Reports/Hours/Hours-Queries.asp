...
" Order By Last_Name"
	Case 7
	BuildLoopQuery = "SELECT DISTINCT m.dc_number, m.First_Name, m.Last_Name" & _
" FROM Master_Roster m INNER JOIN Attend_Bootcamp c ON m.dc_number = c.dc_number" & _
...
" Order By Last_Name" 
	Case 10
	 BuildLoopQuery = "SELECT m.First_Name, m.Last_Name, m.dc_number" & _
" FROM Master_Roster m INNER JOIN Attend_am_AdminOffSpec c ON m.dc_number = c.dc_number" & _
" WHERE Status_am = 'P' AND Class_Date_am >= '"&fromDate&"' AND Class_Date_am <= '"&toDate&"'" & _
" OR Status_am = 'E' AND Class_Date_am >= '"&fromDate&"' AND Class_Date_am <= '"&toDate&"'" & _
" UNION" & _
" SELECT m.First_Name, m.Last_Name, m.dc_number" & _
" FROM Master_Roster m INNER JOIN Attend_pm_AdminOffSpec c ON m.dc_number = c.dc_number" & _
" WHERE Status_pm = 'P' AND Class_Date_pm >= '"&fromDate&"' AND Class_Date_pm <= '"&toDate&"'" & _
" OR Status_pm = 'E' AND Class_Date_pm >= '"&fromDate&"' AND Class_Date_pm <= '"&toDate&"'" & _
" Order By Last_Name" 
End Select
