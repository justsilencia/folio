...
<%
  ...
  If Not rsStudent.EOF Then
	...
	End if
		  ...
		  rsMonth2.Open strMonth2, conYb, adOpenForwardOnly, adLockReadOnly, adCmdText
  ...
  If Not rsStudent.EOF Then
	...
	End if
		  ...
		  Set rsMonth2 = Server.CreateObject("ADODB.RecordSet")
		  rsMonth2.Open strMonth2, conYi, adOpenForwardOnly, adLockReadOnly, adCmdText
  ...
  If Not rsStudent.EOF Then
	...
	End if
		  ...
		  Set rsMonth2 = Server.CreateObject("ADODB.RecordSet")
		  rsMonth2.Open strMonth2, conYg, adOpenForwardOnly, adLockReadOnly, adCmdText
  ...
  If Not rsStudent.EOF Then
	...
	End if
		  ...
		  Set rsMonth2 = Server.CreateObject("ADODB.RecordSet")
		  rsMonth2.Open strMonth2, conMas, adOpenForwardOnly, adLockReadOnly, adCmdText
