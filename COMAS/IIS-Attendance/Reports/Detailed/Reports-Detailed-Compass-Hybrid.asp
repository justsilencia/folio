...
<Center>
<h2><U><%=Request.QueryString("Class")%></U></H2>             
           <br>

<Form Name="NewStudent" Action="ReportRedirect-Detailed-Compass-Hybrid.asp" Method=Post>
<Table Border=0>
<TR>
	<TD>Hybrid Group:</TD>
	<td><Select Name="hybrid_group">
		<option value="305">305</option>
		<option value="307">307</option>
		<option vlaue="308">308</option>
