...
For intCount = 1 to 31
		...
		If IsDate(argDay) = True then
			...
			If wDay <> "1" AND wDay <> "7" Then
				...
				intPresent =  getStudentsPresent("AM", strClass, Session("Class"), argDay, "No")
...
For intCount = 1 to 31
	...
	If IsDate(argDay) = True Then
		...
		strPresent = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&argDay&"'" & _
					"AND status_am = 'P' " & _
					"OR class_date_am = '"&argDay&"'" & _
					"AND status_am = 'E' " & _
					"OR class_date_am = '"&argDay&"'" & _
					"AND status_am = 'LP' " 

		strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&argDay&"'" & _
