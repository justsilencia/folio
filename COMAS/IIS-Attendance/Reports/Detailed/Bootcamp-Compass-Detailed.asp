...
<%
	...
	strPage = "SELECT COUNT(DISTINCT m.dc_number) FROM master_roster m INNER JOIN attend_btu_compass a ON m.dc_number = a.dc_number WHERE a.class_number = '" & Session("Class") & "'" & _
...
%>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.95pt'>
  ...
  <td class=xl7426149 colspan=7><%=rsTeacher("Class")%>&nbsp;(<%=Session("Number")%>) Compass 100 Live</td>
  <td>&nbsp;&nbsp;&nbsp;</td>
  <td>&nbsp;&nbsp;&nbsp;</td>
...
<%
	...
	strDetail = "SELECT DISTINCT m.dc_number, last_name, first_name, a.class_number " & _
                "FROM master_roster m INNER JOIN attend_btu_compass a ON a.dc_number = m.dc_number " & _
...
'        end if
    ...
    strStatus = "SELECT hours, Class_Date FROM attend_btu_compass WHERE class_Date >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
...
'END OF 2 - 24 LOOP FOR ROWS. BELOW BEGINS CODE FOR ROW 25
	...
	strStatus = "SELECT Status, Class_Date FROM attend_btu_compass WHERE Class_Date >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
		    "AND Class_Date <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"' AND Class_Number LIKE '%" & Session("Number") & "%'" & _
		    "AND dc_number LIKE '%" & rsDetail("dc_number") & "%'" & _
...
<%
	...
	strMember = "SELECT COUNT(hours) FROM attend_btu_compass a inner join class_assignment c on a.dc_number = c.dc_number" & _
                " WHERE Class_Date = '"&Session("Month3")&"/"&memCount&"/"&Session("Year")&"'" & _
 		        "AND a.Class_Number = '" & Session("Number")&"'" 
...
<%
	...
	If wDay <> "1" AND wDay <> "7" Then
		...
		strMember = "SELECT hours FROM attend_btu_compass WHERE Class_Date = '"&Session("Month3")&"/1/"&Session("Year")&"' " & _
					"AND class_number = '" & Session("Number")&"'"
...
<%
	...
	strMember = "SELECT hours FROM attend_btu_compass WHERE class_date = '"&Session("Month3")&"/"&tpCount&"/"&Session("Year")&"'" & _
 		        "AND class_number = '" & Session("Number") & "' "
...
<td class=xl8726149 style='border-top:none;border-left:none'>
 <%
	...
	strMember = "SELECT hours FROM attend_btu_compass WHERE Class_Date = '"&Session("Month3")&"/29/"&Session("Year")&"'" & _
				"AND class_number = '" & Session("Number")& "'"
...
<%
	...
	strMember = "SELECT hours FROM attend_btu_compass WHERE Class_Date = '"&Session("Month3")&"/30/"&Session("Year")&"'" &_
				"AND class_number = '" & Session("Number")&"'"
...
<%
	...
	strMember = "SELECT hours FROM attend_btu_compass WHERE Class_Date = '"&Session("Month3")&"/31/"&Session("Year")&"'" &_
				"AND class_number = '" & Session("Number")&"'"
...
<%
 	...
 	DIM total_class_days
        ...
        strMember = "SELECT COUNT(DISTINCT class_date) FROM attend_btu_compass WHERE class_date >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 		            "AND class_date <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _
		            "AND Class_Number = '" & Session("Number") & "'"
...
<%
        ...
        strHoursQuery = "select hours from attend_btu_compass where class_date >= '"&Session("Month3")&"/1/"&Session("Year")&"' and class_date <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _
                         "AND Class_Number = '" & Session("Number") & "'"
