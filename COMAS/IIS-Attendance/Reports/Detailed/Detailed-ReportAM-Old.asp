...
<%
	...
	strPage = "SELECT COUNT(DISTINCT m.dc_number) FROM Master_Roster m INNER JOIN attend_am_"&strClass&" a " & _
              " ON m.dc_number = a.dc_number WHERE class_date_am >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 ...
 <tr height=21 style='mso-height-source:userset;height:15.95pt'>
  ...
  <%
    ...
    If Session("Class") = "Energy-Tech" Then
		...
		Response.Write "X600600-2"

	End If

    If Session("Class") = "Marine-Tech" Then
		
		Response.Write "T400210-2"
...
<%
	...
	strDetail = "SELECT DISTINCT m.dc_number, Last_Name, first_name, subject  FROM Master_Roster m INNER JOIN attend_am_"&strClass&" a ON a.dc_number = m.dc_number WHERE class_date_am >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
...
<% 	
	...
	strStatus = "SELECT status_am, class_date_am FROM attend_am_"&strClass&" WHERE class_date_am >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
  ...
  Response.Write "<td class=xl9226149 style='border-left:none'>"
	...
	If Not rsStatus.EOF Then
	   ...
	   intDateCheck = day(intDate)
		...
		Response.Write rsStatus("Status_am")

		strHourpull = "SELECT Hours From ClassAM_Hours WHERE Date = '"& rsStatus("Class_Date_am") & "' AND Class = '"& strComp &"'"
		rsHourpull.Open strHourpull, eduConn, adOpenForwardOnly, adLockReadOnly, adCmdText


		If rsStatus("Status_AM") = "P" OR rsStatus("Status_AM") = "E" Then
...
<%
	...
	strDays = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
		  "AND class_date_am <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"' AND Subject LIKE '%" & Session("Class") & "%'" & _
		  " AND status_am = 'P'  AND dc_number LIKE '%" & rsDetail("dc_number") & "%'" & _
                  ...
                  " AND status_am = 'E'  AND dc_number LIKE '%" & rsDetail("dc_number") & "%'" & _

                  "OR class_date_am >= '"&Session("Month3")&"/1/"&Session("Year")&"'  AND class_date_am <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"' AND Subject LIKE '%" & Session("Class") & "%'" & _
                  " AND status_am = 'LP'  AND dc_number LIKE '%" & rsDetail("dc_number") & "%'"
...
'	For intCount = 1 to Session("Days3")
		argDay = Session("Month3")&"/1/"&Session("Year")
		intMembers = getMembership("AM", strClass, Session("Class"), argDay, "No")
...
'	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
...
'                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
'		argDay = Session("Month3")&"/2/"&Session("Year")
'		intMembers = getMembership("AM", strClass, Session("Table"), argDay, "No")
'       daily_Membership_count = intMembers
'		Response.Write intMembers
'		If intCount = 1 then
'			total_Membership_count = daily_Membership_count
...
'		intMembers = 0
		...
		strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/2/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/3/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/4/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/5/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/6/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/7/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/8/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/9/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/10/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/11/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/12/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/13/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/14/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/15/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/16/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/17/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/18/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/19/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/20/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/21/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/22/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/23/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/24/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/25/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/26/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/27/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/28/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/29/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/30/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/31/"&Session("Year")&"'" & _
 		    "AND status_am <> ''  AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                    "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                    "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                    "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' " & _
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/2/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/2/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/2/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
	Set rsMember = Server.CreateObject("ADODB.Recordset")
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/3/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/3/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/3/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' "  
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/4/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/4/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/4/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/5/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/5/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/5/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/6/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/6/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/6/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/7/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/7/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/7/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/8/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/8/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/8/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/9/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/9/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/9/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/10/"&Session("Year")&"'" & _
 		    "AND status_am = 'P'  AND Subject LIKE '%" & Session("Class") & "%'" & _
                    ""  & _
                    "OR class_date_am = '"&Session("Month3")&"/10/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/10/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/11/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/11/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/11/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/12/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/12/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/12/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/13/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/13/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/13/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/14/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/14/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/14/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/15/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/15/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/15/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/16/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/16/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/16/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/17/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/17/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/17/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/18/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/18/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/18/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
	Set rsMember = Server.CreateObject("ADODB.Recordset")
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/19/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/19/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/19/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/20/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/20/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/20/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/21/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/21/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/21/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/22/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/22/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/22/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/23/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/23/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/23/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/24/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/24/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/24/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/25/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/25/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/25/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/26/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/26/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/26/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/27/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/27/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/27/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/28/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/28/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/28/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/29/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/29/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/29/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/30/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/30/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/30/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<%
	...
	strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/31/"&Session("Year")&"'" & _
 		    "AND status_am = 'P' AND Subject LIKE '%" & Session("Class") & "%' "  & _
                    "OR class_date_am = '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _
                    "AND status_am = 'E' AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "OR class_date_am = '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _
                    "AND status_am = 'LP' AND Subject LIKE '%" & Session("Class") & "%' " 
...
<tr height=21 style='mso-height-source:userset;height:10.95pt'>
  <td colspan=12 height=21 class=xl13926149 style='border-right:1.5pt solid black;height:10.95pt'>
  PERCENTAGE PRESENT EACH DAY</td>
...
<%
	...
	strPresent = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 		         "AND status_am = 'P' " & _
                 "OR class_date_am = '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
                 "AND status_am = 'E' " & _
                 "OR class_date_am = '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
    ...
    wDay = Weekday(""&Session("Month3")&"/"&countme&"/"&Session("Year")&"")
    
    response.write "<td class=xl8626149 style='border-top:none;border-left:none'>"

    
    thisDate = Session("Month3")&"/"&countme&"/"&Session("Year")

	If wDay <> "1" AND wDay <> "7" Then

	strPresent = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&thisDate&"'" & _
 		         "AND status_am = 'P' " & _
                 "OR class_date_am = '"&thisDate&"'" & _
                 "AND status_am = 'E' " & _
                 "OR class_date_am = '"&thisDate&"'" & _
                 "AND status_am = 'LP' " 

    strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&thisDate&"'" & _
 		        "AND status_am <> '' AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                "AND status_am <> 'RMV' AND status_am <> 'RSD' AND status_am <> 'ENR'" & _
                "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
...
<td colspan=4 class=xl16326149 width=104 style='border-left:1.5pt solid black;  height:10.95pt' style='border-right:.5pt solid black; width:80pt'>
 ...
 <tr class=xl10426149 height=17 style='height:12.75pt'>
  ...
  <td class=Middle colspan=18><B>E</b>=ENTRY; <B>P</b>=PRESENT; <B>LP</B>=LATE/PRESENT; <B>AE</B>=EXCUSED ABSENT; <B>AU</B>=ABSENT UNEXCUSED; 
   <B>X</B>=NO CLASS SESSION;
  <TD>&nbsp;
  <td class=Middle colspan=4>STATUS CODES:</td>
  <td class=Middle colspan=14><B>ADC</B>=ADMINISTRATIVE CHANGE; <B>ATT</B>=ATTAINED EDUCATIONAL OBJECTIVE</TD>
...
<%
 	...
 	DIM total_class_days
        ...
        strMember = "SELECT COUNT(DISTINCT class_date_am) FROM attend_am_"&strClass&" WHERE class_date_am >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 		    "AND class_date_am <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _
		    "AND Subject LIKE '%" & Session("Class") & "%' " & _
            "AND status_am <> 'X' AND status_am <> '' AND status_am <> 'ENR' " & _ 
            "AND status_am <> 'H' AND Status_am <> 'RSD' And Status_am <> 'REF' " & _
            "AND Status_am <> 'RMV' AND Status_am <> 'CMP' " & _
            " AND Status_am <> 'ADC' AND Status_am <> 'NLH'"
...
<%
For bigCounter = 2 to 24
 	scndpgRowCount = bigCounter + 25
	Response.Write  "<tr height=21 style='mso-height-source:userset;height:10.95pt'>" & _
  			"<td height=21 class=xl7526149 style='height:10.95pt;border-top:none'>"&scndpgRowCount&"</td>" & _
  			"<td colspan=7 class=xl14226149 style='border-right:.5pt solid black;border-left:none'>" 
    ...
    next    
        if session("Days3") = "31" then
            ...
            strMember = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&thisDate&"'" & _
 		                "AND status_am <> '' AND status_am <> 'H' AND status_am <> 'ADC' AND status_am <> 'ATT' AND status_am <> 'CMP'" & _
                        "AND status_am <> 'CXS' AND status_am <> 'REF' AND status_am <> 'WTD'" & _
                        "AND status_am <> 'RMV' AND status_am <> 'RSD'" & _
                        "AND status_am <> 'NLH' AND Subject LIKE '%" & Session("Class") & "%' "
