...
<%
	...
	strPage = "SELECT COUNT(DISTINCT m.dc_number) FROM Master_Roster m INNER JOIN attend_pm_compass a ON m.dc_number = a.dc_number WHERE a.subject = '" & Session("Class") & "'" & _
...
<%
	...
	strDetail = "Select distinct m.Last_Name, first_name, m.dc_number  FROM Master_Roster m " & _
		    	...
		    	"where a.subject_pm = '"&Session("Class")&"' AND Compass = 'true'" & _
			    "AND Start_Date_pm <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _ 

                 "UNION " & _

                "Select distinct m.Last_Name, first_name, m.dc_number  FROM Master_Roster m " & _
                "INNER JOIN Attend_pm_compass at on m.dc_number = at.dc_number " & _
		    	"where at.class_date_pm >= '"&Session("Month3")&"/1/"&Session("Year")&"' " & _
                "AND at.class_date_pm <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"' " & _
...
<% 	
	...
	strStatus = "SELECT hours_pm, class_date_pm FROM attend_pm_compass WHERE class_date_pm >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
  ...
  Response.Write "<td class=xl9226149 style='border-left:none'>"
	...
	If Not rsStatus.EOF Then
	   ...
	   intDateCheck = day(intDate)
		...
		Response.Write rsStatus("hours_pm")

        
		If rsStatus("hours_pm") <> "AE" and rsStatus("hours_pm") <> "AU" and rsStatus("hours_pm") <> "ADC" and rsStatus("hours_pm") <> "RSD" _
        and rsStatus("hours_pm") <> "RMV" and rsStatus("hours_pm") <> "CMP" and rsStatus("hours_pm") <> "REF" and rsStatus("hours_pm") <> "NLH" _
        and rsStatus("hours_pm") <> "CXS" and rsStatus("hours_pm") <> "WTD" Then

            intAddhours = rsStatus("hours_pm") + intAddHours
...
<%
	...
	strDays = "SELECT COUNT(hours_pm) FROM attend_pm_compass WHERE class_date_pm >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
		  "AND class_date_pm <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"' AND Subject = '" & Session("Class") & "'" & _
		  " AND hours_pm <> 'AE' AND hours_pm <> 'AU' AND hours_pm <> 'ADC' AND hours_pm <> 'RMV' AND hours_pm <> 'CMP'" & _
          " AND hours_pm <> 'RSD' AND hours_pm <> 'REF' AND hours_pm <> 'CXS' AND hours_pm <> 'WTD' AND dc_number = '" & rsDetail("dc_number") & "'" 
	...
	If Not rsStatus.EOF Then
	   ...
	   intDateCheck = day(intDate)
	    ...
	    If intDateCheck = cellCounter Then
	  	...
	  	Response.Write rsStatus("hours_pm") 
        if rsStatus("hours_pm") = "P" or rsStatus("hours_pm") = "E" then
...
%>
 ...
 <tr height=21 style='mso-height-source:userset;height:13.95pt'>
  ...
  <td class=xl8326149 style='border-left:none'>
	...
	strMember = "SELECT COUNT(hours_pm) FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 		    "AND hours_pm <> ''  AND hours_pm <> 'H' AND hours_pm <> 'ADC' AND hours_pm <> 'ATT' AND hours_pm <> 'CMP'" & _
                    "AND hours_pm <> 'CXS' AND hours_pm <> 'REF' AND hours_pm <> 'WTD'" & _
                    "AND hours_pm <> 'RMV' AND hours_pm <> 'RSD'" & _
                    "AND hours_pm <> 'NLH' AND Subject = '" & Session("Class") & "' " 
...
<%
	...
	strMember = "SELECT COUNT(hours_pm) FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/"&iiCount&"/"&Session("Year")&"'" & _
 		    "AND hours_pm <> ''  AND hours_pm <> 'H' AND hours_pm <> 'ADC' AND hours_pm <> 'ATT' AND hours_pm <> 'CMP'" & _
                    "AND hours_pm <> 'CXS' AND hours_pm <> 'REF' AND hours_pm <> 'WTD'" & _
                    "AND hours_pm <> 'RMV' AND hours_pm <> 'RSD'" & _
                    "AND hours_pm <> 'NLH' AND Subject = '" & Session("Class") & "' " 
...
<%
	...
	strMember = "SELECT COUNT(hours_pm) FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/29/"&Session("Year")&"'" & _
 		    "AND hours_pm <> ''  AND hours_pm <> 'H' AND hours_pm <> 'ADC' AND hours_pm <> 'ATT' AND hours_pm <> 'CMP'" & _
                    "AND hours_pm <> 'CXS' AND hours_pm <> 'REF' AND hours_pm <> 'WTD'" & _
                    "AND hours_pm <> 'RMV' AND hours_pm <> 'RSD'" & _
                    "AND hours_pm <> 'NLH' AND Subject = '" & Session("Class") & "' " 
...
<%
	...
	strMember = "SELECT COUNT(hours_pm) FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/30/"&Session("Year")&"'" & _
 		    "AND hours_pm <> ''  AND hours_pm <> 'H' AND hours_pm <> 'ADC' AND hours_pm <> 'ATT' AND hours_pm <> 'CMP'" & _
                    "AND hours_pm <> 'CXS' AND hours_pm <> 'REF' AND hours_pm <> 'WTD'" & _
                    "AND hours_pm <> 'RMV' AND hours_pm <> 'RSD'" & _
                    "AND hours_pm <> 'NLH' AND Subject = '" & Session("Class") & "' "
...
<%
	...
	strMember = "SELECT COUNT(hours_pm) FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/31/"&Session("Year")&"'" & _
 		    "AND hours_pm <> ''  AND hours_pm <> 'H' AND hours_pm <> 'ADC' AND hours_pm <> 'ATT' AND hours_pm <> 'CMP'" & _
                    "AND hours_pm <> 'CXS' AND hours_pm <> 'REF' AND hours_pm <> 'WTD'" & _
                    "AND hours_pm <> 'RMV' AND hours_pm <> 'RSD'" & _
                    "AND hours_pm <> 'NLH' AND Subject = '" & Session("Class") & "' "
...
<%
	...
	strMember = "SELECT hours_pm FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 		        "AND hours_pm <> 'ADC' AND Subject = '" & Session("Class") & "' " & _
                    "AND hours_pm <> 'RSD' " & _
                    "AND hours_pm <> 'REF' " & _
                    "AND hours_pm <> 'ATT' " & _
                    "AND hours_pm <> 'CXS' " & _
    ...
    do while not rsMember.eof
        ...
        intHours = rsMember("hours_pm") + intHours
...
%>
 ...
 <%
	...
	strMember = "SELECT hours_pm FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/"&iCount&"/"&Session("Year")&"'" & _
 		        "AND hours_pm <> 'ADC' AND Subject = '" & Session("Class") & "' " & _
                    "AND hours_pm <> 'RSD' " & _
                    "AND hours_pm <> 'REF' " & _
                    "AND hours_pm <> 'ATT' " & _
...
<%
	...
	strMember = "SELECT hours_pm FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/29/"&Session("Year")&"'" & _
 		        "AND hours_pm <> 'ADC' AND Subject = '" & Session("Class") & "' " & _
                    "AND hours_pm <> 'RSD' " & _
                    "AND hours_pm <> 'REF' " & _
                    "AND hours_pm <> 'ATT' " & _
...
<%
	...
	strMember = "SELECT hours_pm FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/30/"&Session("Year")&"'" & _
 		        "AND hours_pm <> 'ADC' AND Subject = '" & Session("Class") & "' " & _
                    "AND hours_pm <> 'RSD' " & _
                    "AND hours_pm <> 'REF' " & _
                    "AND hours_pm <> 'ATT' " & _
...
<%
	...
	strMember = "SELECT hours_pm FROM attend_pm_compass WHERE class_date_pm = '"&Session("Month3")&"/31/"&Session("Year")&"'" & _
 		        "AND hours_pm <> 'ADC' AND Subject = '" & Session("Class") & "' " & _
                    "AND hours_pm <> 'RSD' " & _
                    "AND hours_pm <> 'REF' " & _
                    "AND hours_pm <> 'ATT' " & _
...
<%
 	...
 	DIM total_class_days
        ...
        strMember = "SELECT COUNT(DISTINCT class_date_pm) FROM attend_pm_compass WHERE class_date_pm >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 		    "AND class_date_pm <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _
		    "AND Subject = '" & Session("Class") & "' " & _
            "AND hours_pm <> 'X' AND hours_pm <> '' AND hours_pm <> 'ENR' " & _ 
            "AND hours_pm <> 'H' AND hours_pm <> 'RSD' And hours_pm <> 'REF' " & _
            "AND hours_pm <> 'RMV' AND hours_pm <> 'CMP' " & _
            " AND hours_pm <> 'ADC' AND hours_pm <> 'NLH' AND hours_pm <> 'CXS'"
...
<%
    ...
    strMember = "SELECT COUNT(class_date_pm) FROM attend_pm_compass WHERE class_date_pm >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
 		    "AND class_date_pm <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _
		    "AND Subject = '" & Session("Class") & "' " & _
            "AND hours_pm <> 'X' AND hours_pm <> '' AND hours_pm <> 'ENR' " & _ 
            "AND hours_pm <> 'H' AND hours_pm <> 'RSD' And hours_pm <> 'REF' " & _
            "AND hours_pm <> 'RMV' AND hours_pm <> 'CMP' " & _
            " AND hours_pm <> 'ADC' AND hours_pm <> 'NLH' AND hours_pm <> 'CXS' AND hours_pm <> 'AE' AND hours_pm <> 'AU'"
...
<%
        ...
        strHoursQuery = "select hours_pm from attend_pm_compass where subject = '"&Session("Class")&"' " & _
                        "and class_date_pm >= '"&Session("Month3")&"/1/"&Session("Year")&"' and class_date_pm <= '"&Session("Month3")&"/"&Session("Days3")&"/"&Session("Year")&"'" & _
                        "and hours_pm is not null"
        ...
        do while not rsHoursdb.eof
            intAllServed = intAllServed + rsHoursdb("hours_pm")
        rsHoursdb.movenext
        loop
        rsHoursdb.close
