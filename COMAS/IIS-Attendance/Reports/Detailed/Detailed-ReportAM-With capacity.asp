...
<%
	...
	strPage = "SELECT COUNT(DISTINCT m.dc_number) FROM Master_Roster m INNER JOIN attend_am_"&strClass&" a ON m.dc_number = a.dc_number WHERE a.subject LIKE '%" & Session("Class") & "%'" & _
...
<% 
	...
	strPresent = "SELECT COUNT(status_am) FROM attend_am_"&strClass&" WHERE class_date_am = '"&Session("Month3")&"/2/"&Session("Year")&"'" & _
 		         "AND status_am = 'P' " & _
                 "OR class_date_am = '"&Session("Month3")&"/2/"&Session("Year")&"'" & _
                 "AND status_am = 'E' " & _
                 "OR class_date_am = '"&Session("Month3")&"/2/"&Session("Year")&"'" & _
...
<%
 	...
 	DIM total_class_days
        ...
        strMember = "SELECT COUNT(DISTINCT class_date_am) FROM attend_am_"&strClass&" WHERE class_date_am >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
		    ...
		    "AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "AND status_am <> 'X'" & _
                    "AND status_am <> '' And status_am <> 'REF' AND status_am <> 'ENR' AND status_am <> 'H' AND Status_am <> 'RSD' AND Status_am <> 'RMV' AND Status_am <> 'CMP' AND Status_am <> 'ADC' AND Status_am <> 'NLH'"
...
<%
        ...
        strMember = "SELECT COUNT(DISTINCT class_date_am) FROM attend_am_"&strClass&" WHERE class_date_am >= '"&Session("Month3")&"/1/"&Session("Year")&"'" & _
		    ...
		    "AND Subject LIKE '%" & Session("Class") & "%' " & _
                    "AND status_am <> 'X'" & _
                    "AND status_am <> '' AND status_am <> 'H' AND Status_am <> 'RSD' AND Status_am <> 'RMV' AND Status_am <> 'CMP' AND Status_am <> 'ADC' AND Status_am <> 'NLH'"
