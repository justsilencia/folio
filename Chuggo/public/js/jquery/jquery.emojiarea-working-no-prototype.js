...
(function($, window, document) {
	...
	// CUSTOMIZE function for inserting hashtag if user chooses in hashtag dialog.
	util.insertHashtag = function(hashtag, selection) {
	...
	util.insertHashtagList = (function() {
		if (window.getSelection) {
			return function(sel, partialHashtag) {
				...
				function hashClick(e, el, sel) {
					el.remove();
					util.insertHashtag(e.target.innerText, sel);
				}
	...
	var EmojiArea_WYSIWYG = function($textarea, options) {
		...
		// CUSTOMIZE: Allow for an enter property that dictates whether a user is posting.
	...
	EmojiArea_WYSIWYG.prototype.onChange = function(e) {
		...
		if (e && e.keyCode) {
		// Code to remove the hashtag modal box if the user presses spacebar while it is open.
	...
	EmojiArea_WYSIWYG.prototype.handleHashtag = function(partialHashtag) {
			...
			util.insertHashtagList(selection, partialHashtag);  
	};
